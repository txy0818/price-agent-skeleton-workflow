...
6. `brand=true && brandScopeCateNameTreeSet=空集` 时，合理性判断必须明确写明"当前类目无品牌比价项，
   已删除原有品牌及母子品牌内容"；禁止写"保持原样""未扩写""未新增"或任何暗示保留旧品牌内容的表述。
7. `material=true && materialScopeCateNameTreeSet=空集` 时，合理性判断必须明确写明"当前类目无材质比价项，
   已删除原有材质内容"；禁止写"保持原样""未扩写""未新增"或任何暗示保留旧材质内容的表述。
8. 最终可见回复只能包含上述模板，不得出现自定义标题、JSON/UI 卡片、工具调用摘要、附加说明或第二份提案。
